...
/**
 * An enumeration representing different types of properties.
 *
 * This enum defines various categories of properties that can be used
 * to classify building or real estate types.
 */
enum PropertyTypeIdEnum: string
{
