...
class CasafariTest extends TestCase
{
  ...
  "Version": 0.1
        ...
        $CasafariWithMock = new Casafari(Casafari::DEVELOPMENT_SERVER_URL, $_ENV['CASAFARI_TOKEN']);
...
//         new Casafari('https://invalid.url', $_ENV['CASAFARI_TOKEN']);
//     }
//
...
//     }
    ...
    {
        $this->casafari = new Casafari(Casafari::DEVELOPMENT_SERVER_URL, $_ENV['CASAFARI_TOKEN']);
    }
}